...
export const TEMPLATES = {
  ...
  bookDueDateReminderTemplate: (
    name: string,
    bookTitle: string,
    dueDate: string,
    renewUrl: string
  ) => bookDueDateReminderTemplate(name, bookTitle, dueDate, renewUrl),
  bookPreDueReminderTemplate: (
    name: string,
    bookTitle: string,
    dueDate: string,
    renewUrl: string
  ) => bookPreDueReminderTemplate(name, bookTitle, dueDate, renewUrl),
  bookOverdueTemplate: (
    name: string,
    bookTitle: string,
    dueDate: string,
    daysOverdue: number,
    renewUrl: string
  ) => bookOverdueTemplate(name, bookTitle, dueDate, daysOverdue, renewUrl),
  bookReceiptTemplate: (
    name: string,
    bookTitle: string,
    borrowDate: string,
